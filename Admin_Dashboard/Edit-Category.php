...
if (!$A_ID) {
    ...
    if (isset($_POST['Submit'])) {
        ...
        if ($image) {
            ...
            $stmt = $con->prepare("UPDATE categories SET name = ?, image = ? WHERE id = ? ");

            $stmt->bind_param("ssi", $category_name, $image, $category_id);
              ...
              <div class="card-body">
                ...
                <input type="hidden" name="category_id" value="<?php echo $category_id ?>">
                  ...
                  <div class="row mb-3">
                    ...
                    >
                    <div class="col-sm-10">
                      <input type="text" name="name" value="<?php echo $categoryName ?>" class="form-control" id="inputText" required/>
                    </div>
                  </div>
