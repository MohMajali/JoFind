              ...
              <div class="card-body">
                ...
                <input type="hidden" name="offer_id" value="<?php echo $offer_id ?>">
                  ...
                  <div class="row mb-3">
                    ...
                    >
                    <div class="col-sm-10">
                      <input type="text" name="start_date" value="<?php echo date('Y-m-d', strtotime($start_date)) ?>" class="form-control" id="start_date" required/>
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    >
                    <div class="col-sm-10">
                      <input type="text" name="end_date" value="<?php echo date('Y-m-d', strtotime($end_date)) ?>" class="form-control" id="end_date" required/>
                    </div>
                  </div>
